...
def configure(keymap):
    ...
    use_emacs_ime_mode = False ## True

    # emacs日本語入力モードを切り替える（トグルする）キーを指定する
    # toggle_emacs_ime_mode_key = None
    toggle_emacs_ime_mode_key = None ## "C-t"
    ...
    word_register_key = None ## "C-CloseBracket"
